      ...
      <main className="pt-28 pb-16 max-w-4xl mx-auto px-4">
        <div className="card p-8">
          ...
          {[
            ...
            { title: lang === 'hi' ? '8. संपर्क' : '8. Contact', body: lang === 'hi' ? 'किसी भी प्रश्न के लिए guptaarpit.tech@gmail.com पर संपर्क करें।' : 'For any questions, contact us at guptaarpit.tech@gmail.com' }
          ].map(section => (
