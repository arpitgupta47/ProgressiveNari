      ...
      <main className="pt-28 pb-16 max-w-4xl mx-auto px-4">
        <div className="card p-8">
          ...
          {[
            ...
            { title: lang === 'hi' ? '5. आपके अधिकार' : '5. Your Rights', body: lang === 'hi' ? 'आप अपनी जानकारी देख, संशोधित, या हटाने का अनुरोध कर सकते हैं। इसके लिए guptaarpit.tech@gmail.com पर संपर्क करें।' : 'You can request to view, modify, or delete your information. Contact us at support@progressivenaari.com.' },
